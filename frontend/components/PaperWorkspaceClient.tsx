          ...
          <div className="flex min-h-[calc(100vh-13rem)] overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-[#202123]">
            <div className="flex min-w-0 flex-1 flex-col">
                ...
                <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
                  ...
                  {messages.map((message, messageIndex) =>
                    message.role === 'user' ? (
                      <div key={messageIndex} className="flex justify-end">
                        <div className="max-w-3xl rounded-3xl rounded-br-md bg-[#f4f4f4] px-5 py-3 text-sm leading-7 text-gray-900 dark:bg-[#2f2f2f] dark:text-gray-100">
                          {message.content}
                        </div>
                      </div>
                    ) : (
                      <div key={messageIndex} className="flex gap-4">
                        ...
                        <div className="max-w-3xl flex-1 rounded-3xl rounded-bl-md border border-gray-200 bg-white px-5 py-4 shadow-sm dark:border-gray-700 dark:bg-[#2a2b32]">
                          <div className="space-y-4">
                            {message.qaResponse
                  ...
                  {asking ? (
                    <div className="flex gap-4">
                      ...
                      <div className="max-w-3xl rounded-3xl rounded-bl-md border border-gray-200 bg-white px-5 py-4 shadow-sm dark:border-gray-700 dark:bg-[#2a2b32]">
              ...
              <div className="border-t border-gray-200 bg-white px-4 py-4 dark:border-gray-800 dark:bg-[#202123] sm:px-6">
                ...
                {!output.qa_ready ? (
                  <div className="mx-auto max-w-4xl rounded-xl border border-dashed border-gray-200 bg-gray-50 p-4 text-sm text-gray-500 dark:border-gray-800 dark:bg-[#2a2b32] dark:text-gray-400">
                    Still processing...
                  </div>
                ) : (
